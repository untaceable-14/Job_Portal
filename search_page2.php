...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search_box" placeholder="Search for Products, Brands, and Lot" maxlength="100" id="" class="box search-box" required>
...
echo'<h1 class="heading">Products you have searched for...</h1>';
}?>
...
<div class="box-container">
   ...
   <?php
     ...
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE job_name LIKE '%{$search_box}%'"); 
