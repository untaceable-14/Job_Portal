  ...
  <form action="" method="post" enctype="multipart/form-data">
    <div class="flex">
      ...
      <div class="inputBox">
        ...
        <input style="border: .2rem solid #444444;" type="text" name="comp_name" class="box" required placeholder="Enter company name"  min="0" max="9999999999">
      </div>
      <div class="inputBox">
        <span>Location</span>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
      <div class="name"><span><?= $fetch_products['company_name']; ?></span></div></div>
      <div class="name"><span><?= $fetch_products['location']; ?></span></div>
      <div class="flex-btn">
