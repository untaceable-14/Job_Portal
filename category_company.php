...
<section class="products">
   ...
   $select_products = $conn->prepare("SELECT * FROM `products` WHERE company_name LIKE '%{$category}%'"); 
   ...
   if($select_products->rowCount() > 0){
      ...
      <div class="flex">
         ...
         <div class="flex">
            ...
            <div class="flex-btn">
            <a href="quick_view4.php?pid=<?= $fetch_product['id']; ?>" class="btn">view job</a>
            <a href="apply.php?pid=<?= $fetch_product['id']; ?>" class="option-btn" name="apply_now_job">apply</a></div>
            <a href="companies.php" class="delete-btn"> Go Back</a>
            <a href="contact3.php?pid=<?= $fetch_product['company_name']; ?>" class="btn">contact company</a>
            </form>
   <?php 
      }
   }else{
