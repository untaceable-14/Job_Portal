...
if(isset($_POST['submit'])){
   ...
   if($old_pass == $empty_pass){
      ...
      // $message[] = 'Enter a different password to update';
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" readonly name="email" required placeholder="enter your email" maxlength="50"  class="box" oninput="this.value = this.value.replace(/\s/g, '')" value="<?= $fetch_profile["email"]; ?>">
      ...
      <div class="flex-btn">
         ...
         <a href="user_profile.php" class="option-btn">Go Back</a></div>
   </form>
